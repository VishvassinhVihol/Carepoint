...
const DoctorAppointments = () => {
  ...
  const {appointments,dToken,getAllAppointments,cancelAppointment,completeAppointment } = useContext(DoctorContext)
  const {calculateAge,formateDate} = useContext(AppContext)
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll min-h-[80vh]'>
